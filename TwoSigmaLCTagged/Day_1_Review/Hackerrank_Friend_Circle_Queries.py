...
The population of HackerWorld is 10 ** 9. Initially, none of the people are friends with each other. In order to start
a friendship, two persons a and b have to shake hands, where 1 <= a, b <= 10 ** 9. The friendship relation
is transitive, that is if a and b shake hands with each other, a and friends of a become friends with b and friends
of b.
...
Complete the function maxCircle in the editor below. It must return an array of integers representing the size of
the maximum circle of friends after each query.
...
after processing the ith query.
...
After the second query, 1, 2 and 3 all become friends, as 1 shakes hand with 3, 2 also become friends with 3
...
After the last query, person 11 and person 1000000000 become friends, which means 23, 11, 1000000000 and 3778
all become friends. Hence, the answer now increased to 4.
